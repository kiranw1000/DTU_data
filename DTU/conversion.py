...
if __name__ == "__main__":
    ...
    parser.add_argument("--val_split", type=int, default=.1, help="Number of subjects for validation")
    parser.add_argument("--test_split", type=int, default=.15, help="Number of subjects for testing")
